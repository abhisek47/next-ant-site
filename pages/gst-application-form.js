...
class GstUserForm extends Component {
  ...
  render() {
    ...
    return (
      <>
        <Head>
          <title>GST application form</title>
        </Head>
        <HeaderComponent />
        <div className='container application-form'>
          <Title className='application-title'>GST Application Form</Title>
          <Paragraph strong>
            Fill in the below form to apply for GST registration online. It will
